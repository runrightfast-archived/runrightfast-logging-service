 ...
 *            <li>postValidate - OPTIONAL - function(event) - hook that runs
 *            after event is validated that can be used to perform addition
...
(function() {
	...
	module.exports = function(options) {
		...
		if (options) {
			...
			configurePostValidate(options.postValidate);
		}
